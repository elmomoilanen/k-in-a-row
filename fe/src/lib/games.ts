...
export interface Game {
    ...
    readonly timeLimitInSecs: number;
}

export interface GameLevel {
    readonly levelName: string;
    readonly timeRestricted: boolean;
}

export const Games: Record<GameType, Game> = {
    x33: { cellsTotal: 9, cellsToWin: 3, boardSize: "3x3", gameKey: "x33", timeLimitInSecs: 0 },
    x44: { cellsTotal: 16, cellsToWin: 4, boardSize: "4x4", gameKey: "x44", timeLimitInSecs: 0 },
    x55: { cellsTotal: 25, cellsToWin: 4, boardSize: "5x5", gameKey: "x55", timeLimitInSecs: 0 },
    x66: { cellsTotal: 36, cellsToWin: 5, boardSize: "6x6", gameKey: "x66", timeLimitInSecs: 0 },
...
export const GameLevels: Record<LevelName, GameLevel> = {
    easy: { levelName: "Easy", timeRestricted: false },
    normal: { levelName: "Normal", timeRestricted: false },
    hard: { levelName: "Hard", timeRestricted: true }
};
